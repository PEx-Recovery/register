...
export default function OrientationPage() {
  ...
  // Handler to start over - clears all data and returns to home
  const handleStartOver = () => {
    // Clear all cookies
    Cookies.remove('app_status');
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select value={formData.gender} onValueChange={handleSelectChange('gender')}>
                ...
                <SelectContent>
                  {GENDERS.map(option => <SelectItem key={option} value={option}>{option}</SelectItem>)}
                </SelectContent>
              </Select>
            </div>
            <div>
              <label htmlFor="ethnicity" className="block text-sm font-medium text-gray-700 mb-1">Ethnicity <Req /></label>
              <Select value={formData.ethnicity} onValueChange={handleSelectChange('ethnicity')}>
                <SelectTrigger className="w-full">
                  <SelectValue placeholder="Select ethnicity" />
                </SelectTrigger>
                <SelectContent>
                  {ETHNICITIES.map(option => <SelectItem key={option} value={option}>{option}</SelectItem>)}
                </SelectContent>
              </Select>
            </div>
            ...
            <div>
              ...
              <Select value={formData.reasonForAttending} onValueChange={handleSelectChange('reasonForAttending')}>
                <SelectTrigger className="w-full">
                  <SelectValue placeholder="Select reason" />
                </SelectTrigger>
                <SelectContent>
                  {REASONS_FOR_ATTENDING.map(option => <SelectItem key={option} value={option}>{option}</SelectItem>)}
                </SelectContent>
              </Select>
            </div>
          </div>
        ...
        return (
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select value={formData.sourceOfDiscovery} onValueChange={handleSelectChange('sourceOfDiscovery')}>
                <SelectTrigger className="w-full">
                  <SelectValue placeholder="Select source" />
                </SelectTrigger>
                <SelectContent>
                  {SOURCES_OF_DISCOVERY.map(option => <SelectItem key={option} value={option}>{option}</SelectItem>)}
                </SelectContent>
              </Select>
            </div>
            <div>
              ...
              <Select value={formData.problematicSubstances} onValueChange={handleSelectChange('problematicSubstances')}>
                <SelectTrigger className="w-full">
                  <SelectValue placeholder="Select substance/behaviour" />
                </SelectTrigger>
                <SelectContent>
                  {SUBSTANCE_BEHAVIOURS.map(option => <SelectItem key={option} value={option}>{option}</SelectItem>)}
                </SelectContent>
              </Select>
            </div>
            ...
            <div>
              ...
              <Select value={formData.currentlyInTreatment} onValueChange={handleSelectChange('currentlyInTreatment')}>
                <SelectTrigger className="w-full">
            ...
            <div>
              ...
              <Select value={formData.previousTreatment} onValueChange={handleSelectChange('previousTreatment')}>
                <SelectTrigger className="w-full">
                  <SelectValue placeholder="Select option" />
                </SelectTrigger>
                <SelectContent>
            ...
            {formData.previousTreatment === 'Yes' && (
              <div>
                ...
                <Select value={formData.previousTreatmentProgrammes} onValueChange={handleSelectChange('previousTreatmentProgrammes')}>
                  <SelectTrigger className="w-full">
                    <SelectValue placeholder="Select facility" />
                  </SelectTrigger>
                  <SelectContent>
                    {TREATMENT_FACILITIES.map(option => <SelectItem key={option} value={option}>{option}</SelectItem>)}
                  </SelectContent>
                </Select>
              </div>
            )}
            <div>
              ...
              <Select value={formData.previousRecoveryGroups} onValueChange={handleSelectChange('previousRecoveryGroups')}>
                <SelectTrigger className="w-full">
                  <SelectValue placeholder="Select option" />
                </SelectTrigger>
                <SelectContent>
            ...
            {formData.previousRecoveryGroups === 'Yes' && (
              <div>
                ...
                <Select value={formData.previousRecoveryGroupsNames} onValueChange={handleSelectChange('previousRecoveryGroupsNames')}>
                  <SelectTrigger className="w-full">
                    <SelectValue placeholder="Select group" />
                  </SelectTrigger>
                  <SelectContent>
                    {PREVIOUS_GROUPS.map(option => <SelectItem key={option} value={option}>{option}</SelectItem>)}
                  </SelectContent>
                </Select>
              </div>
            )}
            <div>
              ...
              <Select value={formData.goalsForAttending} onValueChange={handleSelectChange('goalsForAttending')}>
                <SelectTrigger className="w-full">
                  <SelectValue placeholder="Select goals" />
                </SelectTrigger>
                <SelectContent>
                  {GOALS_FOR_ATTENDING.map(option => <SelectItem key={option} value={option}>{option}</SelectItem>)}
                </SelectContent>
              </Select>
            </div>
